...
// functional library => library of functions

var _ = {}; // _ is assigned an object
...
*   _.map([1,2,3,4], function(e){return e * 2}) -> [2,4,6,8]
    _.map({ a: 1, b: 2}, function(e){return e * 2}) => [2, 4]
*/

// function has 2 arguments: collection & func
// func => designed to take in one value from the collection
...
//      collection              func
_.map(["a", "b", "c"], function(letter){return letter.toUpperCase()}); // ["A", "B", "C"]
/*
// invoke_.map()
    // []
    // if (["a", "b", "c"] is array) // true
        // for loop
            // i = 0
                // let result = func("a", 0, ["a", "b", "c"])
            // i = 1
                // let result = "B"
                // ["A", "B"]
            // i = 2
...
// higher order functions
    // testing each item !!! for this problem
        // takes in an individual item and returns true or false
    // applying an action to each item
